...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2020/01/18 14:57:45 by vfil              #+#    #+#             */
/*   Updated: 2020/01/18 14:57:51 by vfil             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static const unsigned int g_md5_r[] =
{
...
void				main_algorithm_loop(t_md5 *data, int i,
						unsigned int tmp1, unsigned int tmp2);
void				swap_and_rotate(t_md5 *data, int i,
						unsigned int tmp1, unsigned int tmp2);
